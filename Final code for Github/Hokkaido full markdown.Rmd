...
Treat96<-read_csv('Data/Treatments_96.csv',col_names = T)
Treat140<-read_csv('Data/Treatments_140.csv',col_names = T)
...
First, we'll use the mean of our tiles within each measocosm to look for treatment effects on algal biomass and temporal variability. Then later we'll compare the tiles within mesocosms as our measure of spatial variability. 
